...
4. for each new domain you want to create a crawler, copy the _blank file and save it, name it same as the target host name (eg, for http://amazon.com/ name the file amazon.php, or amazon.com.php), pick a name that you'll remember.
5. install and use browser tools to view xpath and view DOM.  Use the cached html file (no javascript was rendered).
6. study about XPaths
